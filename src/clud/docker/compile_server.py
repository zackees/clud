...
from clud.types import BuildMode, CompileResult, Platform
...
class CompileServer:
    ...
    def __init__(
        ...
        from clud.docker.compile_server_impl import (  # avoid circular import
            CompileServerImpl,
        )
    ...
    def web_compile(
        ...
        return self.impl.web_compile(directory=directory, build_mode=build_mode, profile=profile)
