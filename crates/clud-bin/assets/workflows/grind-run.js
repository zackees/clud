...
if (args.planOnly) {
  ...
  if (!c) return { planOnly: true, path: 'simple', reason: 'planner died', lines: [], problems: allProblems() }
  ...
  return { planOnly: true, path, reason, lines, classification: c, problems: allProblems() }
}
