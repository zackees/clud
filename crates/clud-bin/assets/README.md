...
- `agents/` and `workflows/` - Claude Code agent types (`grind-*`) and the `grind-run` workflow, installed into `~/.claude/` by `src/claude_files.rs`; see [grind.md](../../../docs/architecture/grind.md).
