...
After a failed run, read the failing tests and errors before anything else; rerun unchanged only for an infrastructure error, at most twice, never in a loop.
