...
| [architecture/unified-gateway.md](architecture/unified-gateway.md) | ~80 | #898's authenticated foreground multiplexer: discovery, provider routing, credential isolation, and effort contract |
